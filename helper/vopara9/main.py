...
def main():
    ...
    raw_url = "https://ttc.ninja-web.net/vo-para/vo-para09_list.htm"
    ...
    for row in table_rows:
        ...
        elif c0text in ["株式会社インターネット", "株式会社イーライセンス"] :  # Skip this row (company name, not a circle)
            # print("Skipped company row")
            continue
        elif c0text.startswith("ミクオPARADISE"):
